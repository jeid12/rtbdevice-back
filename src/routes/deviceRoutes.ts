...
router.post('/', authorizeRoles(UserRole.ADMIN, UserRole.SCHOOL), deviceController.createDevice);
router.get('/', authorizeRoles(UserRole.ADMIN, UserRole.SCHOOL), deviceController.getAllDevices);
router.get('/search', authorizeRoles(UserRole.ADMIN, UserRole.SCHOOL), deviceController.searchDevices);
router.get('/statistics', authorizeRoles(UserRole.ADMIN, UserRole.SCHOOL), deviceController.getDeviceStatistics);
router.get('/:id', authorizeRoles(UserRole.ADMIN, UserRole.SCHOOL), deviceController.getDeviceById);
router.put('/:id', authorizeRoles(UserRole.ADMIN, UserRole.SCHOOL), deviceController.updateDevice);
router.delete('/:id', authorizeRoles(UserRole.ADMIN), deviceController.deleteDevice);
